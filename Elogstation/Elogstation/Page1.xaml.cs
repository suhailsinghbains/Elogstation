...
namespace Elogstation
{
    ...
    public partial class Page1 : ContentPage
    {
        ...
        public Page1(string parameter)
        {
            ...
            //If Wifi or Bluetooth is on beforehand, the respective button should be toggled
        ...
        private WifiManager getSystemService(object wIFI_SERVICE)
        {
        ...
        {
            BluetoothManager _manager = (BluetoothManager)Android.App.Application.Context.GetSystemService(Context.BluetoothService);
            if (e.Value)
            {
